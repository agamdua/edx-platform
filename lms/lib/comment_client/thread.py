...
class Thread(models.Model):
    ...
    def flagAbuse(self, user, voteable):
        if voteable.type == 'thread':
            ...
            raise CommentClientRequestError(400, "Can only flag/unflag threads or comments")
    ...
    def unFlagAbuse(self, user, voteable, removeAll):
        if voteable.type == 'thread':
            ...
            raise CommentClientRequestError(400, "Can only flag/unflag for threads or comments")
        params = {'user_id': user.id}
