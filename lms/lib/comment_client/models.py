...
class Model(object):
    ...
    def url(cls, action, params={}):
        if cls.base_url is None:
            raise CommentClientRequestError(400, "Must provide base_url when using default url function")
        if action not in cls.DEFAULT_ACTIONS:
            ...
            try:
                ...
                raise CommentClientRequestError(400, "Cannot perform action {0} without id".format(action))
