...
def emails(from_commit, to_commit):
    ...
    """
    author_emails = set(git.log(from_commit, to_commit, format="tformat:%ae").splitlines())
    committer_emails = set(git.log(from_commit, to_commit, format="tformat:%ce").splitlines())
    return author_emails | committer_emails
